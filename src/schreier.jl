...
"""
Schreier(gens::Vector{<:GroupElem}, pt, op=^) = Schreier(Orbit, gens, pt, op)

@doc doc"""
    Schreier(OrbT::Type{<:AbstractOrbit}, gens, pt[, op=^])
> Compute the Schreier Tree of `pt` under group generated by `gens`.
> The type `OrbT` will be used as a base storage for the orbit.
...
function orbit_stabilizer(gens::Vector{GEl}, pt, op=^) where GEl<:GroupElem
